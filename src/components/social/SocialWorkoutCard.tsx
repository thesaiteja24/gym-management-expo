...
function SocialWorkoutCardInternal({
  workout,
  exerciseTypeMap,
  index = 0,
  onPressComments,
      ...
      <View className="mb-4 flex-col justify-between gap-2">
        ...
        <View className="flex-row items-center justify-between gap-4">
          <Text className="flex-1 text-sm font-normal text-primary">
            <Text className="text-sm font-medium text-black dark:text-white">Duration:</Text>{' '}
            {duration}
          </Text>
      ...
      {recentComments.length > 0 && (
        ...
        >
          ...
          <View className="mt-3 flex-row items-center gap-2 rounded-full bg-neutral-300 p-2 dark:bg-neutral-700">
            ...
            />
            <Text className="text-[14px] text-neutral-500 dark:text-neutral-400">
              Add a comment...
            </Text>
          </View>
        </Pressable>
...
export const SocialWorkoutCard = memo(SocialWorkoutCardInternal)
export default SocialWorkoutCard
