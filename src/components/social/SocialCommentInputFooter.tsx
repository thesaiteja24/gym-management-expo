...
const SocialCommentInputFooterInternal = forwardRef(
  (
    {
    ...
    const isSubmitting =
      addCommentMutation.isPending || addReplyMutation.isPending || editCommentMutation.isPending
...
SocialCommentInputFooterInternal.displayName = 'SocialCommentInputFooter'

export const SocialCommentInputFooter = SocialCommentInputFooterInternal
export default SocialCommentInputFooter
