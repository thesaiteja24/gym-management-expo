...
import { UserBodyFatRing } from './UserBodyFatRing'
...
interface UserMuscleCompositionCardProps {
  composition: CompositionData | null
  gender: 'male' | 'female' | 'other' | null | undefined
  goal?: string | null
}

export function UserMuscleCompositionCard({
  composition,
  gender,
  goal,
}: UserMuscleCompositionCardProps) {
...
export default UserMuscleCompositionCard
