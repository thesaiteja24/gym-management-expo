...
export const UserMeasurementsModal = forwardRef<BaseModalHandle, Props>((_, ref) => {
...
UserMeasurementsModal.displayName = 'UserMeasurementsModal'

export default UserMeasurementsModal
