...
export const UserUnitPreferencesModal = forwardRef<BaseModalHandle, Props>((_, ref) => {
...
UserUnitPreferencesModal.displayName = 'UserUnitPreferencesModal'


export default UserUnitPreferencesModal
