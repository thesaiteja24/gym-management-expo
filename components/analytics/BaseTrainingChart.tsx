import { useTrainingAnalyticsQuery } from '@/hooks/queries/useAnalytics'
				...
				<View className="mt-8 gap-4 px-6">
					...
					<View className="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
						...
						<Text className="mt-2 text-sm text-neutral-500">
							In the last {selectedRange === 'All' ? 'period' : selectedRange}, your training {metricKey}{' '}
							has {stats.diff > 0 ? 'increased' : 'decreased'} by {formatValue(Math.abs(stats.diff))}{' '}
							{unit}.
						</Text>
					</View>
				</View>
