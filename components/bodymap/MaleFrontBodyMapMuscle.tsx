...
const SVGComponent = ({ fills, onPressMuscle }: Props) => {
  const getFill = (id: string) => fills[id] ?? "#E5E7EB";
  return (
    <Svg viewBox="0 0 660.46 1206.46" width="100%" height="100%">
      <G id="neck" onPress={() => onPressMuscle?.("neck")}>
        <Path
      ...
      <G
        id="feet"
        className="bodymap bodymap text-mw-gray"
        onPress={() => onPressMuscle?.("feet")}
      >
        <Path
      ...
      <G id="mid-lower-pectoralis" className="bodymap bodymap text-mw-gray">
        <Path
          ...
          fill={getFill("mid-lower-pectoralis")}
          data-darkreader-inline-fill=""
        />
        <Path
