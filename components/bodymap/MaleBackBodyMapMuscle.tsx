    ...
    <Svg viewBox="0 0 660.46 1206.46" width="100%" height="100%">
      ...
      <G id="medial-hamstrings" className="bodymap bodymap text-mw-gray">
        <Path
          ...
          fill={getFill("medial-hamstrings")}
          data-darkreader-inline-fill=""
        />
        <Path
      ...
      <G id="lateral-hamstrings" className="bodymap bodymap text-mw-gray">
        <Path
          ...
          fill={getFill("lateral-hamstrings")}
          data-darkreader-inline-fill=""
        />
        <Path
      ...
      <G id="medial-head-triceps" className="bodymap bodymap text-mw-gray">
        <Path
          ...
          fill={getFill("medial-head-triceps")}
          data-darkreader-inline-fill=""
        />
        <Path
      ...
      <G id="long-head-triceps" className="bodymap bodymap text-mw-gray">
        <Path
          ...
          fill={getFill("long-head-triceps")}
          data-darkreader-inline-fill=""
        />
        <Path
      ...
      <G id="lateral-head-triceps" className="bodymap bodymap text-mw-gray">
        <Path
          ...
          fill={getFill("lateral-head-triceps")}
          data-darkreader-inline-fill=""
        />
        <Path
