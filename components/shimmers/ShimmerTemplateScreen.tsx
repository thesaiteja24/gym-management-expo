	...
	return (
		<View className="mb-4 rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
			<View className="mb-3 flex-row items-center gap-3">
				{/* Thumbnail */}
				<SkeletonBlock width={40} height={40} rounded={6} />
				<View className="gap-2">
					{/* Title */}
					<SkeletonBlock width={120} height={20} rounded={4} />
					{/* Type */}
					<SkeletonBlock width={60} height={14} rounded={4} />
				</View>
			</View>
			...
			<View className="gap-2">
				...
				{Array.from({ length: 2 }).map((_, i) => (
					<View key={i} className="flex-row items-center rounded bg-neutral-50 p-2 dark:bg-neutral-800/50">
						<View className="w-10">
...
export default function ShimmerTemplateScreen() {
	...
	return (
		<Animated.View entering={FadeInDown.duration(300).springify()} className="flex-1 bg-white dark:bg-black">
			<ScrollView contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
				...
				<View className="border-b border-neutral-100 p-4 dark:border-neutral-900">
					...
					<View className="flex-row gap-4">
						<SkeletonBlock width={80} height={32} rounded={999} />
						<SkeletonBlock width={120} height={32} rounded={999} />
					</View>
				</View>
