...
export const HabitCard = ({ habit }: HabitCardProps) => {
	...
	return (
		<Animated.View entering={FadeInDown.duration(500)}>
			...
			>
				<View>
					<Text numberOfLines={1} className="text-base font-medium text-neutral-600 dark:text-neutral-400">
						{habit.title}
					</Text>
					<Text className="text-xs font-normal text-neutral-400 dark:text-neutral-500">Last 30 Days</Text>
				</View>
