 ...
 * This file exists solely to match the clean URL `pump.thesaiteja.dev/share/:shareId`
 * and redirect it to the internal functional route `(app)/template/share/:shareId`
