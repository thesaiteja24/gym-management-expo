...
export type ActivityLevel = 'sedentary' | 'lightlyActive' | 'moderatelyActive' | 'veryActive' | 'athlete'
...
export type UpdateNutritionPlanBody = Partial<Omit<NutritionPlan, 'id' | 'userId' | 'createdAt' | 'updatedAt'>>
